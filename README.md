...
经过联调与需求收敛，当前阶段以**最小稳定课堂版**为准：

- 教师端只保留：自动扫描、锁屏/解锁、文件分发、作品收取、作品包下发应用
- 学生端只保留：用户名创建/登录、同用户名状态保存与恢复、当前作品打包上传
- 班级/分班/归班功能暂缓，后续重新设计

后续功能修改优先参考：

- [`docs/PRD_MVP.md`](docs/PRD_MVP.md)
- [`docs/开发文档_MVP.md`](docs/开发文档_MVP.md)
