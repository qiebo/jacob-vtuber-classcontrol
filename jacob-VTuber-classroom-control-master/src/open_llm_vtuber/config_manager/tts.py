...
class VolcengineTTSConfig(I18nMixin):
    """Configuration for Volcengine TTS."""

    appid: str = Field("", alias="appid")
    access_token: str = Field("", alias="access_token")
    secret_key: str = Field("", alias="secret_key")
    api_url: str = Field("https://openspeech.bytedance.com/api/v1/tts", alias="api_url")
    cluster: str = Field("volcano_tts", alias="cluster")
    voice: str = Field("BV001_streaming", alias="voice")
    encoding: Literal["mp3", "wav", "pcm", "ogg_opus"] = Field("mp3", alias="encoding")
    sample_rate: int = Field(24000, alias="sample_rate")
    speed_ratio: float = Field(1.0, alias="speed_ratio")
    volume_ratio: float = Field(1.0, alias="volume_ratio")
    pitch_ratio: float = Field(1.0, alias="pitch_ratio")

    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        "appid": Description(en="Volcengine appid", zh="火山引擎 appid"),
        "access_token": Description(
            en="Volcengine access token", zh="火山引擎 access token"
        ),
        "secret_key": Description(
            en="Volcengine secret key (reserved for signed mode)",
            zh="火山引擎 secret key（预留给签名模式）",
        ),
        "api_url": Description(
            en="Volcengine TTS API URL",
            zh="火山引擎 TTS API 地址",
        ),
        "cluster": Description(
            en="Volcengine cluster name",
            zh="火山引擎集群名称",
        ),
        "voice": Description(
            en="Volcengine voice id",
            zh="火山引擎音色 ID",
        ),
        "encoding": Description(
            en="Audio encoding format",
            zh="音频编码格式",
        ),
        ...
        "speed_ratio": Description(
            en="Speech speed ratio",
            zh="语速倍率",
        ),
...
class TTSConfig(I18nMixin):
    ...
    volcengine_tts: Optional[VolcengineTTSConfig] = Field(
        None, alias="volcengine_tts"
    )
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "volcengine_tts": Description(
            en="Configuration for Volcengine TTS", zh="火山引擎 TTS 配置"
        ),
    }
    ...
    def check_tts_config(cls, values: "TTSConfig", info: ValidationInfo):
        ...
        elif tts_model == "volcengine_tts" and values.volcengine_tts is not None:
            values.volcengine_tts.model_validate(values.volcengine_tts.model_dump())
        return values
