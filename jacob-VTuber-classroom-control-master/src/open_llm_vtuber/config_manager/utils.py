...
def scan_config_alts_directory(config_alts_dir: str) -> list[dict]:
    ...
    default_character_config = (
        default_config.get("character_config", {}) if default_config else {}
    )
    config_files.append(
        {
            "filename": "conf.yaml",
            "name": default_character_config.get("conf_name", "conf.yaml"),
            "character_name": default_character_config.get("character_name", ""),
            "persona_prompt": default_character_config.get("persona_prompt", ""),
        }
    )
        ...
        for file in files:
            if file.endswith(".yaml"):
                ...
                config_files.append(
                    {
                        "filename": file,
                        "name": character_config.get("conf_name", file),
