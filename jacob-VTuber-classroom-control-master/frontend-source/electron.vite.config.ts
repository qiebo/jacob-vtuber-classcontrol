    ...
    plugins: [
      viteStaticCopy({
        targets: [
          ...
          {
            src: normalizePath(resolve(__dirname, 'src/renderer/public/libs/silero_vad_legacy.onnx')),
            dest: './libs/vad/',
          },
          {
            src: normalizePath(resolve(__dirname, 'src/renderer/public/libs/silero_vad_v5.onnx')),
            dest: './libs/vad/',
          },
          {
